...
function validateAndTransformClient(rawClient: RawClient): ClientCreateInput {
  ...
  const priorityValue = validatePriority(
    rawClient.priority || rawClient.prioridad || ""
  );
