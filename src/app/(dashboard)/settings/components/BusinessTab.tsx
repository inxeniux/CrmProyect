...
export default function BusinessTab() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      console.error(error);
      showToast.updateLoading(loadingToast, "Error al crear usuario", "error");
    } finally {
      setIsLoading(false);
    }
  };
        ...
        <div className="space-y-3 sm:space-y-4 md:space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4 md:gap-6">
            ...
            <div className="flex flex-col space-y-1">
              <div className="relative">
                <div className="absolute left-0 inset-y-0 pl-3 flex items-center pointer-events-none">
                  <FiLock className="h-4 w-4 md:h-5 md:w-5 text-light-text-tertiary dark:text-dark-text-tertiary" />
                </div>
                <input
                  type="password"
                  name="password"
                  ...
                  className="pl-10 w-full rounded-lg text-sm md:text-base py-2 md:py-3
                         bg-light-bg-input dark:bg-dark-bg-input 
                         border ${errors.password ? 'border-error-light' : 'border-light-border-medium dark:border-dark-border-medium'}
                         text-light-text-primary dark:text-dark-text-primary
                         focus:ring-2 focus:ring-primary-50 focus:border-transparent
                         transition-all duration-200"
                />
            ...
            <div className="flex flex-col space-y-1">
              <div className="relative">
                ...
                <input
                  ...
                  className="pl-10 w-full rounded-lg text-sm md:text-base py-2 md:py-3
                         bg-light-bg-input dark:bg-dark-bg-input 
                         border ${errors.businessId ? 'border-error-light' : 'border-light-border-medium dark:border-dark-border-medium'}
                         text-light-text-primary dark:text-dark-text-primary
                         focus:ring-2 focus:ring-primary-50 focus:border-transparent
                         transition-all duration-200"
                />
